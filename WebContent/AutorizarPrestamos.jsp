                ...
                <tbody>
                    ...
                    %>
                        <tr>
                            ...
                            <td><%= cliente.getDni() %></td> <!-- Mostrar DNI del cliente -->
                            <td><%= cliente.getApellido() %></td> <!-- Mostrar Apellido del cliente -->
                            ...
                            <td>
                                <form action="SlAutorizarPrestamo" method="post" style="display:inline;">
                                    <input type="hidden" name="numeroPrestamo" value="<%= prestamo.getId() %>">
