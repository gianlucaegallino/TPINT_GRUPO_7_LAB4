	...
	<div class="formulario-agregar" id="formularioAgregarUsuario" style="display: block;">
		...
		<input type="hidden" name="action" value="agregarUsuario">
			<div class="form-container">
				<div class="fila" id="Username_Contrasena">
					<div class="form-element">
                		...
                		<input type="text" id="UsernameUsuario" name="UsernameUsuario" placeholder="Ingrese un nombre de Usuario" required>
					</div>
					<div class="form-element">
						<label for="ContrasenaUsuario">CONTRASEÑA:</label>
                		<input type="password" id="ContrasenaUsuario" name="ContrasenaUsuario" placeholder="Ingrese una contraseña" required>
					</div>
					<div class="form-element">
						<label for="ConfirmarContrasenaUsuario">CONFIRMAR CONTRASEÑA:</label>
                		<input type="password" id="ConfirmarContrasenaUsuario" name="ConfirmarContrasenaUsuario" placeholder="Ingrese la contraseña de nuevo" required>
					</div>
				</div>
			...
			<div class="button-container">
				<input type="submit" value="Guardar Usuario" name="btnAgregarUsuario">
			</div>
		</form>
