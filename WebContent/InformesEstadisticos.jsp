	...
	<form action="#" method="post">
		...
		<fieldset>
			...
			<label for="fechaPrestamoDesde">Fecha de Préstamo Desde:</label> <input
				...
				required><br>
			<br> <label for="fechaPrestamoHasta">Fecha de Préstamo
				Hasta:</label> <input type="date" id="fechaPrestamoHasta"
				name="fechaPrestamoHasta" required><br>
			<br> <label for="montoMinimo">Monto Mayor a:</label> <input
				type="number" id="montoMinimo" name="montoMinimo" min="0"
