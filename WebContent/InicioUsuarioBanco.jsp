...
<body class="bodyInicio">
	<header class="headerInicio">
		<div class="logo">
			<a href="InicioUsuarioBanco.jsp"> <img src="images/logo.png"
				alt="Logo" class="icon" />
			</a>
		</div>
		<!--
	...
	<article class="menus">
		...
		<input class="botonInicio" id="botonABMLCliente" type="submit"
			value="Cliente" onClick="window.location.href='Clientes.jsp'" />


		<input class="botonInicio" id="botonABMLCuenta" type="submit"
			value="Cuentas" onClick="window.location.href='Cuentas.jsp'" />

		<input class="botonInicio" id="botonABMLUsuario" type="submit"
