    ...
    <div class="transfer-container">
      ...
      <select id="cuenta" name="cuenta">
        <option value="caja_ahorro">
          Caja de Ahorro - CBU: 1234567890123456789012
        </option>
        <option value="cuenta_corriente">
          Cuenta Corriente - CBU: 2345678901234567890123
        </option>
        <option value="caja_ahorro2">
          Caja de Ahorro - CBU: 3456789012345678901234
        </option>
      </select>
      ...
      <label for="cbu_destinatario">CBU del destinatario</label>
      <input
        type="text"
        id="cbu_destinatario"
        name="cbu_destinatario"
