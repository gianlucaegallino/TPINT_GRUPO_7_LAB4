...
<body class="bodyInicio">
    <article class="menu-gestiones">
        <a href="Cuentas.jsp" class="botonGestion">Agregar</a>
        <a href="EditarEliminarCuenta.jsp" class="botonGestion">Editar/Eliminar</a>
                    ...
                    <td>
                        ...
                        <form action="SlCuentas" method="post">
                            <input type="hidden" name="idCuenta"
                                value="<%=cuenta.getNumero_cuenta()%>" />
                            <input type="hidden" name="cbu" value="<%=cuenta.getCbu()%>" />

                            <!-- Campos para modificar CBU y saldo -->
                            <input type="text" name="cbuModificar"
                                value="<%=cuenta.getCbu()%>" placeholder="Nuevo CBU">
                            <input type="text" name="saldoModificar"
                                value="<%=cuenta.getSaldo()%>" placeholder="Nuevo Saldo">
