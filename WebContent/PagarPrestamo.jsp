...
%>
    <%@ include file="Inicio.jsp" %> <!-- Incluimos el inicio -->
      ...
      <body class="bodyPrestamo">
        <div class="containerPrestamo">
          ...
          <form action="PagarPrestamo.jsp" method="post">
            <label for="cuotaSeleccionada">Seleccionar Cuota:</label>
            <select id="cuotaSeleccionada" name="cuotaSeleccionada" required>
            ...
            <label for="cuenta">Cuenta para Descuento:</label>
          ...
          <table class="historialCuotas" border="1">
            ...
            <tbody>
              ...
              <tr>
                <td>Cuota <%= i %></td>
                <td>
                  <%= cuotasPagadas.containsKey(i) ? "Pagada" : "Pendiente" %>
                </td>
