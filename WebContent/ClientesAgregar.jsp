            ...
            <div class="form-container">
                <div class="fila" id="DNI_CUIL">
                    <div class="form-element">
                        ...
                        <input type="text" id="DniCliente" name="DniCliente" placeholder="Ingrese un DNI"  
                        pattern="[0-9]{7,8}" 
                         maxlength="8"
                    ...
                    <div class="form-element">
                        ...
                        <input type="text" id="CUILCliente" name="CUILCliente" placeholder="Ingrese un CUIL" 
                         pattern= "(20|23|24|27)[0-9]{9}"
                          maxlength="11"
                ...
                <div class="fila" id="Nombre_Apellido">
                    <div class="form-element">
                        ...
                        <input type="text" id="nombreCliente" name="nombreCliente" placeholder="Ingrese un nombre" 
    ...
    <select id="LocCliente" name="LocCliente" required>
        ...
        %>
            ...
            <div class="button-container">
                <input type="submit" value="Guardar Cliente" name="btnAgregarCliente">
            </div>
        </form>
