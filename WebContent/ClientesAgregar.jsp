		...
		<form action="SIClientes" method="POST" id="formcli">
			...
			<div class="form-container">
				<div class="fila" id="DNI_CUIL">
					<div class="form-element">
						<label for="DniCliente">DNI:</label> <input type="text"
							id="DniCliente" name="DniCliente" placeholder="Ingrese un DNI"
					...
					<div class="form-element">
						<label for="CUILCliente">CUIL:</label> <input type="text"
							id="CUILCliente" name="CUILCliente" placeholder="Ingrese un CUIL"
							pattern="(20|23|24|27)[0-9]{9}" maxlength="11"
							title="El CUIL debe tener 11 dígitos y comenzar con 20, 23, 24 o 27 y sin ' - '."
							value="<%= request.getAttribute("CUILCliente") != null ? request.getAttribute("CUILCliente") : "" %>"
							required>
					</div>
				</div>
				<div class="fila" id="Nombre_Apellido">
					...
					<div class="form-element">
						<label for="apellidoCliente">APELLIDO:</label> <input type="text"
					...
					<div class="form-element">
						<label for="telefonoCliente">TELEFONO:</label> <input type="text"
							...
							placeholder="Ingrese su telefono" pattern="[0-9]{8,10}"
							maxlength="10"
							title="El teléfono debe tener entre 8 y 10 dígitos."
							value="<%= request.getAttribute("telefonoCliente") != null ? request.getAttribute("telefonoCliente") : "" %>"
							required>
					</div>
				</div>
				<div class="fila">
					<div class="form-element">
						<label for="SexoCliente">GENERO:</label> <select id="SexoCliente"
                    ...
                    for (Nacionalidad nacionalidad : nacionalidades) {
                      %>
							<option value="<%= nacionalidad.getId() %>"
								<%=(nacionalidad.getId()== nacCliente)?" selected":"" %>><%= nacionalidad.getNombre() %></option>
							<% 
							      }
							  } else { 
							    %>
                ...
                %>
					...
					<div class="form-element">
						<label for="FNacimientoCliente">FECHA DE NACIMIENTO:</label> <input
							type="date" id="FNacimientoCliente" name="FNacimientoCliente"
				...
				<div class="fila">
					<div class="form-element">
						<label for="CorreoCliente">CORREO:</label> <input type="email"
							id="CorreoCliente" name="CorreoCliente"
							placeholder="Ingrese un Correo Electronico"
							value="<%= request.getAttribute("CorreoCliente") != null ? request.getAttribute("CorreoCliente") : "" %>"
							required>
					</div>
				</div>
			</div>
