...
<body class="bodyPrestamo">
    <div class="containerPrestamo">
        ...
        <form action="PedirPrestamo.jsp" method="post">
            ...
            <input type="number" id="monto" name="monto" required value="<%= monto > 0 ? monto : "" %>">

            <label for="cuotas">Cantidad de Cuotas:</label>
            <select id="cuotas" name="cuotas">
                <option value="6" <%= cuotas == 6 ? "selected" : "" %>>6 meses</option>
                <option value="12" <%= cuotas == 12 ? "selected" : "" %>>12 meses</option>
                <option value="24" <%= cuotas == 24 ? "selected" : "" %>>24 meses</option>
           </select>
        ...
        <p>Interes Anual: <%= (tasaInteres * 100) + "%" %></p>
        <p>Interes Total: <%= new DecimalFormat("#.##").format(interesTotal) + "%" %></p>
        <p>Cuota Mensual: <%= new DecimalFormat("#.##").format(cuotaMensual) %></p>
